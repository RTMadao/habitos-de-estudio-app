<template>
    <v-container fluid pa-0>
        <v-app-bar style="background-color:#0099cc" app>
            <v-spacer></v-spacer>
            <!--<router-link to="/crearCuenta">--><v-btn text @click="leer()">Crear Cuenta</v-btn><!--</router-link>-->
            <span> | </span>
            <v-btn text @click="login()">Inicia sesión</v-btn>
        </v-app-bar>
